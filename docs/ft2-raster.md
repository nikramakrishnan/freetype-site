...
<p>This flag is only used in direct rendering mode. If set, the output will be clipped to a box specified in the <code>clip_box</code> field of the <a href="../ft2-raster/#ft_raster_params">FT_Raster_Params</a> structure.</p>
